...
file dist/jdk17/bin/jaybird-VERSION.jar jar
file dist/jdk17/test/jaybird-test-VERSION.jar jar test
file dist/jdk17/sources/jaybird-VERSION-sources.jar jar sources
file dist/jdk17/javadoc/jaybird-VERSION-javadoc.jar jar javadoc
end
...
file dist/jdk17/bin/jaybird-full-VERSION.jar jar
file dist/jdk17/test/jaybird-test-VERSION.jar jar test
file dist/jdk17/sources/jaybird-full-VERSION-sources.jar jar sources
file dist/jdk17/javadoc/jaybird-VERSION-javadoc.jar jar javadoc
end
...
file dist/jdk17/bin/jaybird-cryptoapi-VERSION.jar jar
file dist/jdk17/sources/jaybird-cryptoapi-VERSION-sources.jar jar sources
end
...
file dist/jdk17/bin/jaybird-cryptoapi-security-VERSION.jar jar
file dist/jdk17/sources/jaybird-cryptoapi-security-VERSION-sources.jar jar sources
end
