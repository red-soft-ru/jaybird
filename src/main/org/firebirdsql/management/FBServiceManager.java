...
public class FBServiceManager implements ServiceManager {
    ...
    public String getGeneratedKeysEnabled() {
        return serviceProperties.getGeneratedKeysEnabled();
    }

    @Override
    public void setGeneratedKeysEnabled(String generatedKeysEnabled) {
        serviceProperties.setGeneratedKeysEnabled(generatedKeysEnabled);
    }

    @Override
    public String getDataTypeBind() {
        return serviceProperties.getDataTypeBind();
    }

    @Override
    public void setDataTypeBind(String dataTypeBind) {
        serviceProperties.setDataTypeBind(dataTypeBind);
    }

    @Override
    public String getSessionTimeZone() {
        return serviceProperties.getSessionTimeZone();
    }

    @Override
    public void setSessionTimeZone(String sessionTimeZone) {
        serviceProperties.setSessionTimeZone(sessionTimeZone);
    }
