...
public interface FirebirdConnectionProperties {
    ...
    String AUTH_PLUGINS = "authPlugins";
    String GENERATED_KEYS_ENABLED = "generatedKeysEnabled";
    String DATA_TYPE_BIND = "dataTypeBind";
    String SESSION_TIME_ZONE = "sessionTimeZone";
    String IGNORE_PROCEDURE_TYPE = "ignoreProcedureType";
    String WIRE_COMPRESSION = "wireCompression";
    ...
    String NOT_ENCRYPTED_PASSWORD = "not_encrypted_password";
