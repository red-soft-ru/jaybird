...
public class FBConnectionProperties implements FirebirdConnectionProperties, Serializable, Cloneable {
    ...
    public static final String CERTIFICATE = PropertyNames.certificate;
    public static final String REPOSITORY_PIN = PropertyNames.repositoryPin;
    public static final String SERVER_CERTIFICATE = PropertyNames.serverCertificate;
