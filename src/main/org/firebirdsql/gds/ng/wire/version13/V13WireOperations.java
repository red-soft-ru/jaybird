...
public class V13WireOperations extends V11WireOperations {
    ...
    public static final String WIRE_WINCRYPT_PLUGIN_SPI_CLASS_NAME =
            "org.firebirdsql.gds.ng.wire.crypt.wincrypt.WireWinCryptEncryptionPluginSpi";
    ...
    static {
        ...
        for (String spiName : Arrays.asList(ARC4_PLUGIN_SPI_CLASS_NAME, CHA_CHA_PLUGIN_SPI_CLASS_NAME,
                WIRE_WINCRYPT_PLUGIN_SPI_CLASS_NAME)) {
            try {
