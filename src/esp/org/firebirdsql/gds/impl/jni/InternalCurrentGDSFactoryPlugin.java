...
import org.firebirdsql.jdbc.InternalCurrentConnection;


public class InternalCurrentGDSFactoryPlugin implements GDSFactoryPlugin {
   ...
   public static final String INTERNAL_TYPE_NAME = "INTERNAL";
    ...
    public Class getConnectionClass() {
        return InternalCurrentConnection.class;
    }
    ...
    public GDS getGDS() {
        ...
        if (gds == null)
            gds = new InternalCurrentGDSImpl();
