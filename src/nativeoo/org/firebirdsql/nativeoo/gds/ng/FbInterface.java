...
public interface FbInterface extends FbClientLibrary
{
	...
	public static interface IRequestIntf extends IReferenceCountedIntf
	{
		...
		public void receive(IStatus status, int level, int msgType, int length, byte[] message);
		public void send(IStatus status, int level, int msgType, int length, byte[] message);
		...
		public void startAndSend(IStatus status, ITransaction tra, int level, int msgType, int length, byte[] message);
	...
	public static interface IAttachmentIntf extends IReferenceCountedIntf
	{
		...
		public void replicate(IStatus status, int length, byte[] data);
	}
	...
	public static interface ITracePluginIntf extends IReferenceCountedIntf
	{
		...
		public boolean should_cancel_on_error();
	...
	public static class IWriter extends IVersioned implements IWriterIntf
	{
		public static class VTable extends IVersioned.VTable
		{
			...
			{
				java.util.List<String> fields = super.getFieldOrder();
				fields.addAll(java.util.Arrays.asList("reset", "add", "setType", "setDb", "setPassword", "changeLogin"));
				return fields;
			}
		}
	...
	public static class ITracePlugin extends IReferenceCounted implements ITracePluginIntf
	{
		public static class VTable extends IReferenceCounted.VTable
		{
			...
			public static interface Callback_should_cancel_on_error extends com.sun.jna.Callback
			{
				public boolean invoke(ITracePlugin self);
			}
			...
			public VTable(final ITracePluginIntf obj)
			{
				...
				should_cancel_on_error = new Callback_should_cancel_on_error() {
					@Override
					public boolean invoke(ITracePlugin self)
					{
						return obj.should_cancel_on_error();
					}
				};
			...
			public Callback_should_cancel_on_error should_cancel_on_error;
		...
		{
			VTable vTable = getVTable();
			if (vTable.should_cancel_on_error == null) {
				return false;
			}
			boolean result = vTable.should_cancel_on_error.invoke(this);
			return result;
		}
	...
	public static class ILdapPlugin extends IReferenceCounted implements ILdapPluginIntf
	{
		...
		{
			VTable vTable = getVTable();
			if (vTable.change_mf_password == null) {
				return 0;
			}
