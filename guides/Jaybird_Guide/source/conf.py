...
extensions = ['sphinx_design', 'NewCodeBlockDirective', 'HideShowIfCertDirective', 'HideShowIfCertRole', 'UnindentedListDirective']
...
latex_documents = [
 ('index', 'Jaybird_Guide.tex', u'Ред База Данных', u'YourName', 'article'),
]
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[R]{Руководство по Jaybird\\\rightmark}
